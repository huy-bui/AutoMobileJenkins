...
public class BaseTest {
	...
	protected static String envPath = "src" + fileSeperator + "test" + fileSeperator + "resources" + fileSeperator
			+ "environments";
	...
	public void setups(@Optional String env) throws Exception {
		...
		if (environment == null || environment.equalsIgnoreCase("${env}")) {
			envFolderPath = projectPath + fileSeperator + envPath + fileSeperator + "testing";
			...
			envFolderPath = projectPath + fileSeperator + envPath + fileSeperator + environment;
			configsFolderPath = envFolderPath + fileSeperator + "configs";
			testDataFolderPath = envFolderPath + fileSeperator + "testData";
		} else {
